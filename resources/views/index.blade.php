            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        <a href="post.html">
                            <h2 class="post-title">Bagaimana cara belajar programming yang efektif di 2022?</h2>
                            <h3 class="post-subtitle">Nothing</h3>
                        </a>
                        <p class="post-meta">
                            Diposting oleh
                            <a href="#!">Ibrahim Rangkuti</a>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Ibrahim Rangkuti 2022</div>
                    </div>
                </div>
            </div>
        </footer>
